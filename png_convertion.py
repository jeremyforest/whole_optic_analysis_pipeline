...
def png_conversion(input_data_folder, output_data_folder):
    # input_data_folder = '/media/jeremy/Data/local/Data_manip/2020_01_16/experiment_5/raw_data'
...
if __name__ == "__main__":
    ...
    experiment = 'experiment_merged_37_39'

    path_input = '/media/jeremy/Data/local/Data_manip/2019_12_24/{}/'.format(experiment)
    path_input_raw_data = '/media/jeremy/Data/local/Data_manip/2019_12_24/{}/raw_data'.format(experiment)
    path_output = '/media/jeremy/Data/local/Data_manip/2019_12_24/{}/images/'.format(experiment)
