...
from utils.files_handling import images_list, read_image_size


def merge_npy(input_data_folder, output_data_folder, experiment):
    """
    ...
    json_file_path = f"{input_data_folder}/{experiment}/experiment_132_info.json"
    output = []
    ...
    for file in tqdm(files):
        ...
        output.append(image)
    merged_npy_file_path = f"{output_path}/raw_data.npy"
